{
  ...
  programs.niri = {
    ...
    settings = {
      ...
      ## FIXME: How do you call this when the derivation uses the `{inputs, ...}:` pattern and `with ...;`
      # binds = pkgs.callPackage ./keybinds.nix {};
